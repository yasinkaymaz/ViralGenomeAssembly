...
my $mosaikpath = "/project/umw_jeffrey_bailey/share/bin_sync/MOSAIK-2.2.3-Linux-x64/";
my $samtoolspath = "/share/pkg/samtools/0.0.19/";
my $mosaiknetworkpath = "/project/umw_jeffrey_bailey/share/bin_sync/MOSAIK-2.2.3-Linux-x64/networkFile/";
